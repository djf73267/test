...
public class MyMP3Fiel implements Playable, Comparator<Playable> {
    ...
    // constructor
    public MyMP3Fiel() { // empty play list named "Untitled"
        this.name = "Untitled";
        playableList = new ArrayList<Playable>();
    }

    public MyMP3Fiel(String newName) { // empty play list
        this.name = newName;
        playableList = new ArrayList<Playable>();
    }
    ...
    public boolean addPlayList(MyMP3Fiel pl) {
